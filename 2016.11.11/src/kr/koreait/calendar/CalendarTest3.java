...
//		날짜를 출력한다.
		for(int k=0; k < calen.length; k+=3) {
			System.out.printf ("         %d년 %2d월        ", year, k+1);
			System.out.print("       ");
			System.out.printf ("         %d년 %2d월        ", year, k+2);
			System.out.print("       ");
			System.out.printf ("         %d년 %2d월        ", year, k+3);
			System.out.print("       ");
			System.out.println();
			...
			for(int i=0; i < calen[k].length; i++) {
				...
				System.out.print("       ");
				for(int j=0; j < calen[k][i].length; j++) {
					System.out.printf(" %2d ", calen[k+1][i][j]);
				}
				System.out.print("       ");
				for(int j=0; j < calen[k][i].length; j++) {
					System.out.printf(" %2d ", calen[k+2][i][j]);
				}
				System.out.println();
			}
			System.out.println();			
